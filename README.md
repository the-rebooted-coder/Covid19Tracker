...
# Covid19 Tracker
## An Android App which displays detailed information about Covid 19 
###### Using this app the User can see all the information related to the Novel Pandemic using 3 Simple windows which have dynamic content update.
